const navbar = (
  <nav className="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div className="container">
      <a className="navbar-brand js-scroll-trigger" href style={{fontFamily: '"Rubik", sans-serif'}}>Ziggy's world</a>
      ...
      <div className="collapse navbar-collapse" id="navbarResponsive">
        <ul className="navbar-nav ml-auto" style={{fontFamily: '"Rubik", sans-serif !important'}}>
          <li className="nav-item mx-0 mx-lg-1">
            <a className="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">View plans</a>
          </li>
          <li className="nav-item mx-0 mx-lg-1">
